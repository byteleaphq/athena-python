...
class CreateURLDocumentRequestBody:
...
@dataclasses.dataclass
class CreateURLDocumentRequest:
    brain_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'brain_id', 'style': 'simple', 'explode': False }})
    request_body: Optional[CreateURLDocumentRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateURLDocumentResponse:
